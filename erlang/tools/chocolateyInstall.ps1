...
$package = 'erlang'
$url64 = 'https://github.com/erlang/otp/releases/download/OTP-29.0.6/otp_win64_29.0.6.exe'
$checksum64 = 'd2f4fd611501a581b278439ddacfdf7a95f61e4a393dfa095cb6eff9b38fd3ff'
$ertsVersion = '17.0.6'
